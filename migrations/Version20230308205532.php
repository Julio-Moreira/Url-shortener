 ...
 */
final class Version20230308205532 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , complete_url CLOB NOT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema): void
    {
        ...
        , accesses CLOB DEFAULT NULL --(DC2Type:json)
        , complete_url VARCHAR(255) NOT NULL, short_url VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
